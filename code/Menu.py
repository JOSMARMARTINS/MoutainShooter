...
class Menu:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./assent/MenuBg.png').convert_alpha()
        ...
        while True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    quit()  # end pygame
                #   Seleção no menu para baixo
                if event.type == pygame.KEYDOWN: # verifica se é tecla para baico DOWN KEY
                    ...
                    if event.key == pygame.K_UP: # Verfica se é telcla para cima UP KEY
                        if menu_option > 0:
                            menu_option -= 1
                        else:
